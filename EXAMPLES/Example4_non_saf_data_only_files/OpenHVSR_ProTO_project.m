...
% AND ONLY DATA COLUMNS ARE PRESENT 
%
% IN THIS EXAMPLE:
%    * ADDITIVE TOPOGRAPHICAL POINTS WERE INCLUDED
%    * A WELL WAS INCLUDED (FEATURE STILL UNDER DEVELOPMENT)
%
datafile_separator = 'none';%  this is the header/data separator in data files,
%                              must be set as 'none' here.
%                              No text lines in the data files! only columns of data. 
